...
export const DATASETS = [
  ...
  {
    id: 'votecompassfinancial',
    label: 'ABC: I am finding it difficult to cope financially on my current income (Vote Compass)',
    sourceLabel: 'ABC Vote Compass',
    canCombine: true,
    unit: '%',
  },
  {
    id: 'votecompasswomen',
    label: 'ABC: Political parties should commit to running at least as many women candidates as they do men (Vote Compass)',
    sourceLabel: 'ABC Vote Compass',
    canCombine: true,
    unit: '%',
  },
...
export const Y_AXIS_METHODS = [
  ...
  },
  {
    id: 'swingtolnp2019',
    isSwing: true,
    label: 'Change in Coalition primary vote since 2019',
  },
  {
    id: 'lnpprimary',
    isSwing: false,
  ...
  },
  {
    id: 'lnpprimaryswing',
    isSwing: true,
    label: 'Change in Coalition primary vote since 2022',
  },
  ...
  },
  {
    id: 'swingtolabor2019',
    isSwing: true,
    label: 'Change in Labor primary vote since 2019',
  },
  {
    id: 'laborprimary',
    isSwing: false,
  ...
  },
  {
    ...
    isSwing: true,
    label: 'Change in Labor primary vote since 2022',
  },
